...
#             (eliminar visualização da imagem para melhorar desempenho)
...
def main():
    ...
    while True:
        ...
        cv2.rectangle(frame, (20, 20), (200, 200), (255, 255, 2), 4)  # retângulo mais externo
        ROI = frame[20:200, 20:200]
        ...
        if contours:
            ...
            cv2.circle(ROI, center, 15, [255, 0, 255], 2)
